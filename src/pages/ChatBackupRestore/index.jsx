        ...
        <aside className="flex flex-col md:hidden justify-start md:px-5 w-[350px]">
          ...
          >
            ...
            <div className="flex flex-col items-start justify-start mt-6 pt-0.5 w-full">
              ...
              <Text
                className="font-medium leading-[26.00px] mt-4 text-bluegray_900 text-left"
                variant="body2"
              >
                <>
                  Local: 3:21 am
              ...
              <Text
                className="font-normal leading-[26.00px] mt-4 not-italic text-bluegray_400 text-left w-full"
                variant="body2"
              >
              ...
              <Button
                className="cursor-pointer font-medium min-w-[302px] mt-6 text-center text-sm text-white_A700 w-auto"
            ...
            <div className="flex flex-col gap-[21px] justify-start mt-[29px] rounded-md w-full">
              <Text
                className="bg-blue_50 font-medium h-[38px] pb-1.5 pl-4 sm:pr-5 pr-[35px] pt-[11px] rounded-md text-blue_A700 text-left w-[300px]"
                variant="body2"
              >
                Cloud Settings
              </Text>
              <div className="flex flex-col gap-3.5 items-start justify-start ml-4 md:ml-[0] w-auto md:w-full">
                <Text
            ...
            <div className="flex flex-col gap-[21px] justify-start mb-[353px] mt-6 rounded-md w-full">
              <Text
                className="bg-blue_50 font-medium h-[38px] pl-[31px] pr-[35px] sm:px-5 py-2.5 rounded-md text-blue_A700 text-left w-[300px]"
                variant="body2"
              >
                Account
              </Text>
